...
function! ctrlp#bdelete#init()
  ...
  if has_key(g:ctrlp_buffer_func, 'enter')
    if g:ctrlp_buffer_func['enter'] != 'ctrlp#bdelete#mappings'
      let s:ctrlp_bdelete_user_func = g:ctrlp_buffer_func['enter']
    endif
  endif

  let g:ctrlp_buffer_func['enter'] = 'ctrlp#bdelete#mappings'
endfunction

" Buffer function used in the ctrlp settings (applies mappings).
function! ctrlp#bdelete#mappings(...)
